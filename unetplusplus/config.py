...
parser.add_argument("-or", "--output_path", type=str, default="/media/ri2raj/External HDD/gta5_new/")
...
parser.add_argument("-mp", "--ModelPath", type=str, default="/media/ri2raj/External HDD/gta5_new/best_Model.pkl")
